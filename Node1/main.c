/**
  ...
  * MADE BY ANDY AZUCAR
  * 
  * MADE TO CONTROL NUCLEO-G474RE BOARDS VIA TOUCHGFX GUI
  *
  * 
  *
  ******************************************************************************
...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
extern QSPI_HandleTypeDef hqspi __attribute__((weak));
/* USER CODE END PM */
...
int main(void)
{
  ...
  sFilterConfig.FilterIndex = 1;  // Second filter
    sFilterConfig.FilterType = FDCAN_FILTER_MASK;  // Assuming the same type of filter
    sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;
    sFilterConfig.FilterID1 = 0x112;
    sFilterConfig.FilterID2 = 0x7FF;
    HAL_FDCAN_ConfigFilter(&hfdcan1, &sFilterConfig);


    sFilterConfig.FilterIndex = 2;  // S
      sFilterConfig.FilterType = FDCAN_FILTER_MASK;  // Assuming the same type of filter
      sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;
      ...
      sFilterConfig.FilterIndex = 3;  //
          sFilterConfig.FilterType = FDCAN_FILTER_MASK;  // Assuming the same type of filter
          sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;
          sFilterConfig.FilterID1 = 0x114;
          sFilterConfig.FilterID2 = 0x7FF;
          HAL_FDCAN_ConfigFilter(&hfdcan1, &sFilterConfig);

  /* Configure Tx FIFO message */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : VSYNC_FREQ_Pin MCU_ACTIVE_Pin */
